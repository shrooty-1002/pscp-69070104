...
```text
ก็คือโจทย์นี้ให้หา หมายเลขแถบ ของดอกไม้ดอกสุดท้าย โดยจำลองการ เดินเฉียงขึ้นขวาบนทีละก้าว จากจุดเริ่มต้นจนครบ ดอก พอเดินจบก้าวสุดท้าย ค่อยเอาตำแหน่งแถวและคอลัมน์มาหารด้วยความหนา เพื่อระบุว่าตกอยู่แถบไหน
```
...
```
โทรทำกะเพื่อนค่ะ แบบโทรกัน 3-4 คนเลยค่ะ 
---
...
```text
ก็ช่วยๆกันคิดว่าควรเขียนโค้ดอะไร คือช่วยๆกันทำคนละครึ่ง ช่วยทำให้เข้าใจโจทมากขึ้น แต่ส่วนใหญ่บารมีเพื่อนค่ะ
```

คุณยังทำอะไรด้วยตนเอง

```text
input ละก็ช่วยๆเสนอตรงลุป แต่ก็มีผิิดบ้าง ละก็ช่วยคิดตรง block
```

คุณคัดลอก code จากคนอื่นหรือไม่

```text
ไม่อยากใช้คำว่าคัดลอก เพราะทำด้วยกัน 
```
