...
```text
ก็คือรับค่า r1r2 g1g2 b1b2 มาค่ะ ทำให้เป็น int ืั้งหมดพร้อมันเลยใช้ map ละก็จับตัวแรกมาบวกกันหารสอง เพื่อหาค่าเฉลี่ย ทำงี้หมดทุกทั้งสามตัว   
```
...
ก็ทำเองงค่ะแค่ให้เพื่อนแปลโจทย์ให้ฟังก่อน 
---
...
```text
ถามแค่ว่าให้แปลโจทย์ค่ะ อ่านแล้วไม่เข้าใจ ตีโจทย์ไม่เป็นค่ะ
```
