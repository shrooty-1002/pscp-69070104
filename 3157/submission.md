...
```text
ก็คือ โจทจะให้เรารับค่าเลขมาตัวนึง แทนค่าว่าเราจะทำการบวกลบกี่รอบ ละก็ถ้าเป็น + จะบวก 10 ถ้าเป็น - จะ -5 แบบนี้ไปเรื่อยๆ
```
...
```
ก็นั่งทำเองไปเรื่อยๆ จนกว่าจะถูก พอดีมีข้อที่คิดว่าคล้ายกัน เลยพอถูไถได้
---
...
```text
ลองคิดเองสักข้อ เช็คความเข้าใจตัวเอง
```
