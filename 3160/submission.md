...
```text
ก้คือจะมีเลขมาให้ ตัวแรกคือจำนวนเริ่มวึ่งเราจะไม่นับมันด้วย ตัวสองคือเลขจบ ที่เราจะเอามันมารวมด้วย ละก็หาว่าในเลขสองเลขมีจำนวนเฉพาะกี่จำนวน 
```
...
```text
input ละก็ช่วยๆเสนอตรงลุป แต่ก็มีผิิดบ้าง ละก้ตรง len 
```
