...
```
ตอนนั้นมันเป็นคู่pairพอดีเลยช่วยทำกะคู่ 
---
...
```text
เพราะว่าเป็นเทสเคสที่พิมเองในโจทข้อนี้ และเป็นชื่อตัวเอง
```
...
```text
เพราะโจทให้มา เลยลองดูว่าจะตรงกันไหม
```
...
```text
ช่วยตรง reversed_letter เพราะว่าตอนนั้นลืมโค้ดตัวนี้ไป
```

คุณยังทำอะไรด้วยตนเอง

```text
ใส่อินพุต ละก็ใส่ [::-1].lower()
```
