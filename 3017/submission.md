...
```text
ก็คือ โจทจะให้ราคาอาหารมา เราต้องเอาค่าบริการ 10% และค่า vat 7% ไปคิดว่าสุดท้ายแล้วค่าอาหารเท่สากับเท่าไร
```
...
```
นั่งทำที่บ้านและก็ทำไปเรื่อยๆเลยถามเพื่อน
---
...
```text
เอาตามเอ้าพุตที่ให้มาครั้งสุดท้ายว่าถูกไหม
```
...
```text
ตอนแรกหนูเขียนแบบไม่มี if else แล้วก็งงและทำผิด เพื่อนเลยแนะนำวิธีที่ง่่ายกว่านั้น
```

คุณยังทำอะไรด้วยตนเอง

```text
ที่เหลือทำเองหมดค่ะ มีแอบเสิชวิธีีคิดค่า vat ในกก. แต่ที่เหลือทำเองค่ะ
```
