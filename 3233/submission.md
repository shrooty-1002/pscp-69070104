...
```text
ก็คือจะเป็นการซื้อหวย และถ้าเลขถูกตามที่เขากำหนดก็จะได้ราคาาตามที่ถูก ก็คือค่าอินพุตค่าที่ถูกกัยค่าที่ซื้อมาก่อน แล้วก็เอามา.split() ละก็เอาletter1 = right[0] num1 = right[1] และ letter2 = buy[0] num2 = buy[1] ละก็เอาค่ามาแยกตามราคาที่เขากำหนด ถูกสามตัวหลัง ก็same_3lastnum = num1[-3:] == num2[-3:] ทำแบบนี้เช่นเดียวกับถูกสองตัวท้าย ละก็ใส่ if else ตามราคาที่ถูก กับที่เขากำหนดว่าถูกเท่านี้ๆๆ ได้ราคาเท่านี้ๆๆ   
```
...
```
ก็นั่งทำไปเรื่อยๆ ค่อยๆคิด ทำเองแบบชิวๆ
---
...
```text
คิดเองเพื่อเช็คความเข้าใจตัวเอง
```
