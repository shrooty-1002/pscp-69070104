...
```text
ก็คือ โจทจะให้เราหาตัวเลขในช่วง [A,B] มีกี่ตัวที่หารกับ d แล้วเหลือเศา r แล้วเอ้าพุตออกมาเป็นจำนวนที่ตรงกับค่าที่เราต้องการ
```
...
```
ก็นั่งทำเองไปเรื่อยๆ จนกว่าจะถูก พอไม่ได้ก็ถามพี่สาวให้มาช่วยนิดหน่อย
---
...
```text
ช่วยแก้บรรทัด count เพราะตอนแรกนี่เขียนว่า count += 1 เพราะถนัดใช้อันนี้ แต่มันต้องกำหนดตัวแปรให้มัน บวกกับวิธีที่พี่บอกมาสั้นและกระชับกว่า และก็ช่วยใบ้ว่าตรงprint ให้ใช้ f-string 
```

คุณยังทำอะไรด้วยตนเอง

```text
ที่เหลือก็ทำเองหมดเลย เขียนอินพต .lower() เอย if เอย print ก็เขียนเองถึงแม้พี่จะใบ้ 
```
