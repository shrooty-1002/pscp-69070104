...
```text
ก็คือ โจทจะให้เราแปลงอุณหภูมิไป เช่นจาก K ไป R โดยโจทจะมีสูตรให้ เราแค่ต้องนำมาเขียน 
```
...
```
นั่งทำที่บ้านและก็ทำไปเรื่อยๆจนกว่าจะถูก มันก็ไม่ถูกสักทีเลยรอทำกะคู่pair ละเพื่อนก็สอนจนเข้าใจ
---
...
```text
ข้อคำนวณจะเน้นใช้ที่โจทให้มาเอง เพราะว่าหนูไม่อยากคิดเลขเองค่ะ
```
...
```text
เพื่อดูว่าโค้ดหนูถูกจนสามารถถูกทุกเอ้าพุตทั้งสามข้อที่โจทให้มาได้ไหม
```
...
```text
ตอนแรกหนูก็ทำเองตลอด แต่ว่าเหมือนจะทำผิดไปเยอะ คือเข้าใจแล้วว่าควรจะเปลี่ยนทุกอันเป็น C แต่หนูน่าจะนอนน้อยแล้วเปลี่ยนเป็น C แล้วหนูก็ยังจะ เปลี่ยนเป็นอุธภูมิอื่นด้วย เลยพลาดอยู่อย่างงั้น ก็เลยปลงละก็มาทำกะคู่pair ละเขาบอกหนูมาถูกทางแล้ว แต่ออกทะเลไปไกล เขาเลยสอนๆ ละหนูก็ถึงบางอ้อ ก็เลยเข้าใแล้วค่ะ
```

คุณยังทำอะไรด้วยตนเอง

```text
ทำเองจนถึงเปลี่ยนทั้งหมดเป็น C ละคู่ก็อธิบายว่าำพอเป็นงี้แล้วอาจจะทำงี้ หรือทำงี้แล้วอาจจะง่ายกว่านะ ละหนูก็ลองพิมเอง เสิชหาสูตรเปลี่ยนเองอะไรเองหมด เพราะตรง R เหมือนต้องใช้ 491.67 ด้วย 
```
