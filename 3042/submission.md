...
```text
ก็คือ โจทจะให้เรารับเลขมมา 1 ค่า ละก็ใให้เอ้าพุตออกมาเป็นเลขนั้นหรือเลขใกล้เลขนั้นที่หาร10 ลง ไปเรื่อยๆ จนถึง 0
```
...
```
นั่งทำที่kllcและก็ทำไปเรื่อยๆจนกว่าจะถูก แต่ที่นั่นtap มันเหมือนกดspace bar 3 รแบเท่านั้น ทำถูกก็qualityไม่เต็ม100 เลยต้องมาแก้พวกนี้ใหม่ตอนทำแล้บ pscp
---
...
```text
เช็ดรอบสุดท้ายว่าโค๊ดเราถูกต้องไหม เพราะว่าเลขอันนี้ไม่ได้ลงท้ายด้วย 0 เหมือนอันอื่น เลยจะดูว่ามันยังถูกไหม
```
