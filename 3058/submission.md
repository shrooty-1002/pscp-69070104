...
```text
ก็คือ โจทจะให้เราสร้างสะพาน โดยมีอิฐสองแบบ คือก้อนเล็กและก้อนใหญ่ โดยที่ก้อนเล็ก = 1 นิ้ว และก้อนใหญ่ = 5 นิ้ว  และก็ถ้าก้อนใหญ่เยอะเกินก็ใช้เท่าที่ต้องใช้ ไม่จำเป็นต้องใช้ให้หมด แต่เน้นใช้ก้อนใหญ่ก่อนแล้วค่อยก้อนเล็็ก
```
...
```
ก็นั่งทำเองไปเรื่อยๆ ลองคิดสูตรละก็ใส่ๆไป ตอนแรกก็มาถูกทางแล้ว แต่ก็ยังผิดเลยไปถามพี่สาว พี่สาวแนะนำให้ใช้ used_b กับ want_a ด้วย ก็เลยลองเอามาทำอีกรอบ แล้วก็ทำได้
---
...
```text
ลองตามโจทอีกรอบเพื่อความเมคชัวว่าเอ้าพุตเหมือนกัน
```
...
```text
ลองคิดเองสัดข้้อ เพื่อเช็คความเข้าใจตัวเอง
```
...
```text
ช่วยแนะนำว่าให้มี used_b กับ want_a และก็ใบ้ๆว่า ควรใช้อะไรยังไง
```

คุณยังทำอะไรด้วยตนเอง

```text
ใส่อินพุต คิดเอาเองว่า used_b want_a หายังไง if else เขียนอะไร 
```
