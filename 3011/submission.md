...
```text
ก็คือ โจทจะให้ชื่อมา ไม่ว่าจะตัวเล็กหรือใหญ่ เอ้าพุตเราต้องเป็นชื่อที่กลับหน้าหลัง ตัวแรกไปท้าย ตัวหลังมาข้างหน้า ละข้างในก็เปลี่ยนตามๆกัน และเอ้าพุตต้องเป็นพิมพ์เล็กทั้งหมด
ก็คือ โจทจะให้เราผสมสีตามที่กำหนดมา แดง+เหลืองได้ส้ม แดง+น้ำเงินได้ม่วง เหลือง+น้ำเงินได้เขียว นอกเหนือจากนี้เป็นerror
```
...
```
นั่งทำในคอมม่อนก่อนตอนแรก แล้วทำไปเรื่อยๆก็เลยถามรุ่นพี่แถวนั้นให้มาช่วย 
---
...
```text
เพราะตอนแรกที่ได้ลองทำแล้วมันผิด แล้วทำให้รู้ว่าต้องเพิ่มโค้ดอีกบรรทัด 
```
...
```text
ตอนแรกที่หนูทำเอง หนูไม่ได้ใส่ว่า ถ้า else: print("Error) พอใส่เทสเคส Red Black มันเลยผิด เขาเลยบอกว่าต้องใส่อันนี้ด้วย
```

คุณยังทำอะไรด้วยตนเอง

```text
ทุกอย่างเลยค่ะ ยกเว้น else: print("Error) ใน if ย่อยๆ
```
