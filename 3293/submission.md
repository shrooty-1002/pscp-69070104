...
```text
ก็คือโจทย์จะให้คำมา5บรรทัดสิ่งที่เราต้องทำคือจากเฟรมกรอบให้มัน โดยที่กรอบใหญ่แค่ไหนขึ้นอยุ่กับคำที่ยาวทที่สุด และก็เพิ่ม * ไป2 อันหน้าหลัง ความยาวของคำนั้น    
```
...
```text
input ละก็ช่วยๆเสนอตรงลุป แต่ก็มีผิิดบ้าง
```
