...
```
ก็เคยอ่านแต่เห็นยาวมากเลยปล่อย ละวันนี้เดดไลนเลยมาทำจริง ละก็โทรทำกะเพื่อน 
---
...
```text
เวลากระชั้นชิด เลยใช้ที่โจทให้มาทั้งหมด 
```
...
```text
ก็ช่วยๆกันคิดว่าควรเขียนโค้ดอะไร คือช่วยๆกันทำคนละครึ่ง แบบพวกคิดเลข
```
