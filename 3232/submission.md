...
ก็คือส่งของ จานี่ไปนุ่น มีค่าเก็บเท่านี้ๆ และยังค่าธรรมเนียนน้ำหนักอีกเท่านี้ ให้คิดราาคา

```text
ก็สร้างค่าตัวนึงมา แล้วก็.input().strip() .strip() คือลบช่องว่างหน้าหลัง ละก็ให้ตัวแปร num = card[:-1] เพราะว่าตัวเลขอาจจะมีสองตัวหรือตัวเดียวก็ได้ เลยใส่แค่ [0] ไม่ได้ alphabet ก็คือ เอาแค่ตัวสุดท้ายแต่เราจะใส่ [1] ไม่ได้เพราะไม่รุ้ว่าตัวเลขมีกี่หลักเลยใช้ -1 แทน ละก็เขียนว่าถ้าเป็นตัวนี้ๆๆ rank คืออันนี้ๆๆ ละก็เขียนว่าถ้าเป็้นเลขพวกตัวอักษร ก็จะเป็นอันนี้ๆๆ ละก็ปริ้นค่าออกมา  
```
...
```
ทำเองหมดค่ะ มีแค่ .strip() ที่ถามพี่่ค่ะ 
---
...
```text
ลองที่โจทให้มาทั้งหมดเพื่อเมคชัว
```
...
```text
คือตอนแรกไม่รุ้จริงว่าจะต้องทำไงให้มันติดกัน เลยถามพี่ว่าทำไง มันก็บอกว่าให้ใช้ .strip()
```
