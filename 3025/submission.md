...
```text
ก็คือ โจทจะให้เราเขียนดปรแกรมฤดู วันที่ 123 เป็นฤดูหนาว วันที่456 ฤดูใบ้ไม้ผลิ 789 ฤดูร้อน และ 101112 ฤดูใบไม้ร่วง และฤดูก็จะเปลี่ยนในทุกวันที่21 จฃของเดือนที่ 3 หารลงตัว ก็คือ 3 6 9 12 จากหนาวเป็นผลิ ผลิเป็นร้อน ร้อนเป็นร่วง ร่วงเป็นหนาว
```
...
```
นั่งทำที่บ้านและก็ทำไปเรื่อยๆจนกว่าจะถูก พอถูกก็qualityไม่เต็มร้อยก็เลยไปดูของเพื่อนที่ผ่าน และก็ปรับแก้วิธีเขียนใหม่
---
...
```text
เช็ดรอบสุดท้ายว่าโค๊ดเราถูกต้องไหม
```
...
```text
ไม่ได้มีเพื่อนช่วยตรงๆ แต่ทำเองไปเรื่อยๆ มันผ่านแต่quality ไม่เต็มร้อยสักที เลยไปดูของคนอื่นว่าเขียนไง ละก็ปรับแก้ตามเพื่อน
```

เขาช่วยอะไร

```text
เอ่อก็คงอาจจะทำให้หนูรู้ว่าโค้ดหนูซับซ้อนเกิน
```
