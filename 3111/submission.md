...
```
ก็นั่งทำเองไปเรื่อยๆ จนกว่าจะถูก แต่พอถึงตรงprint ก็เห็นโจทบอกให้ใช้ round half up บอกตรงๆว่าไม่รู้จัก เลยถามเอไอเลย 
---
...
```text
ทำตามโจทหมดเลย เพราะตอนมานั่งทำโจทจริงๆ คือดึกมาก สมองไม่แล่นพอที่จะคิดเลขออกมา
```
...
```text
ทำเองหมดเลย ยกเว้นทุกบรรทัดที่มีคำว่า decimal  
```
