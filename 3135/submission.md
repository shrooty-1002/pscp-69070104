...
```text
ก้คือจะมีกล่องของขวัญให้เราพิจารณา N คือคนเริ่มคนแรก K จำนวนคนที่เว้น T คือโจร ส่งไปเรื่อยๆ ละก็จะจบตอนคนแรกที่เช็คเช็คเป็นครั้งที่สอง ละก๋นับว่าได้พิจารณากี่คนรวมโจรด้วย   
```
...
```text
ก็ช่วยๆกันคิดว่าควรเขียนโค้ดอะไร คือช่วยๆกันทำคนละครึ่ง ช่วยทำให้เข้าใจโจทมากขึ้น 
```
